...
def load_config():
    default = {
        ...
        "glow_radius": 48,
        "show_panel": False,
        "theme_name": "Custom",     # new: remember last theme preset
    }
...
class FloatingClock(QWidget):
    ...
    def paintEvent(self, event):
        ...
        # Slight margin so glow isn't clipped
        margin = 8
        r = QRectF(
            rect.x() + margin,
            rect.y() + margin,
